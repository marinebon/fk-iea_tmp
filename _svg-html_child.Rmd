...
svg_csv <- ifelse(
  ...
  params$csv,
  ifelse(
    "svg_csv" %in% names(rmarkdown::site_config()),
    rmarkdown::site_config()$svg_csv,
    stop("Variable svg_csv missing! Must set svg_csv as parameter in frontmatter of Rmd or in site-wide _site.yml.")))
#svg_csv <- "svg/svg_links.csv"
```
